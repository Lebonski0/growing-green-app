...
export default function IntroScreen() {
  ...
  return (
    <main className="relative bg-intro grain-overlay flex flex-col items-center justify-center min-h-[100dvh] w-full overflow-hidden">
      <div className="relative w-full max-w-[430px] flex flex-col items-center justify-center min-h-[100dvh] mx-auto">
